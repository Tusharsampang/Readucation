...
<body style="background-color: #f7f7f7;">
			...
			<div class="col-md-3">
				<div class="card crd-ho">
					<div class="card-body text-center">
						<img alt="" src="img/books/1.jpg"
							style="width: 150px; height: 200px" class="img-thumblin">
						<p>Ikigi</p>
						<p>Francesc Miralles and Hector Garcia</p>
						<p>Category:Books</p>
						<div class="row ">
							<a href="" class="btn btn-danger btn-sm ml-1"><i class="fa-solid fa-cart-shopping"></i> Add Cart</a> <a
								...
								href="" class="btn btn-danger btn-sm ml-1"><i class="fa-solid fa-rupee-sign"></i> 299</a>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="container">
		<h3 class="text-center">E-Book</h3>
		<div class="row">
			<div class="col-md-3">
				<div class="card crd-ho">
					<div class="card-body text-center">
						<img alt="" src="img/books/2.jpg"
							style="width: 150px; height: 200px" class="img-thumblin">
						<p>Warmth</p>
						<p>Francesc Miralles and Hector Garcia</p>
						<p>Category:Books</p>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="card crd-ho">
					<div class="card-body text-center">
						<img alt="" src="img/books/7.jpg"
							style="width: 150px; height: 200px" class="img-thumblin">
						<p>Srimad Bhagwat Gita</p>
						<p>Bhaktivedanta Swami Prabhupada</p>
						<p>Category:Books</p>
						<div class="row ">
							<a href="" class="btn btn-danger btn-sm ml-2"><i class="fa-solid fa-cart-shopping"></i> Add Cart</a> <a
								href="" class="btn btn-success btn-sm ml-1">View Details</a> <a
